                ...
                <div class="col-lg-10 col-xl-9">
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-lg-5 auth-card-left">
                                <div class="auth-branding">
                                    ...
                                    <h4 class="fw-bold text-white mb-2">Selamat Datang Kembali<br>di IGG Store</h4>
                            ...
                            <div class="col-lg-7 auth-card-right">
                                <div class="auth-form-wrapper">
                                    <div class="text-center mb-4">
                                        ...
                                        <p class="text-muted small">Masuk untuk melanjutkan belanja</p>
                    </div>
                    ...
                    @if($errors->any())
                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                            ...
                            <strong>Oops!</strong> Periksa kembali kredensial Anda.
                            <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                        </div>
                    @endif
                    ...
                    <form method="POST" action="{{ route('login') }}" id="loginForm">
                        ...
                        <div class="d-grid mb-3">
                            <button type="submit" class="btn btn-primary modern-btn" id="loginBtn">
                                <span class="btn-text">
